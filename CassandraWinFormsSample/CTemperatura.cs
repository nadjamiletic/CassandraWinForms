...
{
    public partial class CTemperatura : UserControl
    {
        public CTemperatura()
        {
            InitializeComponent();
        ...
        public void PopuniTemp(string stanicaid, string rekaid, string mesec,int dan)
        {
            ...
            foreach (CassandraDataLayer.QueryEntities.StanjeStanica rek in CassandraDataLayer.DataProvider.GetPodaci(stanicaid, rekaid, mesec,dan))
            {
                ...
                dataGridView1.Rows[n].Cells[1].Value = Convert.ToString(rek.temperatura);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            t.TemperaturaGrafik(CassandraDataLayer.DataProvider.GetPodaci(cbStanica.Text,cbReka.Text,cbMesec.Text,int.Parse(cmbDan.Text)));
            t.Show();
        }

        private void cmbDan_SelectedIndexChanged(object sender, EventArgs e)
        {
            PopuniTemp(cbStanica.Text, cbReka.Text, cbMesec.Text,int.Parse(cmbDan.Text));
